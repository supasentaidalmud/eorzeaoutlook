    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Translations =
        new()
        {
            ["de"] = new()
            {
                ...
                ["Settings.ShowResetsNote"] = "Fügt tägliche, wöchentliche, Gold-Saucer- und Modebericht-Termine hinzu.",
            ...
            ["fr"] = new()
            {
                ...
                ["Settings.ShowResetsNote"] = "Ajoute les réinitialisations quotidiennes, hebdomadaires, Gold Saucer et Rapport de mode.",
            ...
            ["ja"] = new()
            {
                ...
                ["Settings.ShowResetsNote"] = "デイリー、ウィークリー、ゴールドソーサー、ファッションチェックの予定を追加します。",
                ["Sidebar.Events"] = "予定",
                ["Sidebar.Upcoming"] = "今後",
